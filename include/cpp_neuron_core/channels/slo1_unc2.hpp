...
class Slo1Unc2Channel final : public Channel {
public:
    explicit Slo1Unc2Channel(double conductance_nS);
    ...
    double cain_uM_per_um3() const { return cain_uM_per_um3_; }
...
private:
    ...
    double cain_uM_per_um3_ = 0.0001;
