...
| 文件 | 职责 |
| --- | --- |
| [main.cpp](../../../src/neuron/main.cpp) | 进程入口和异常边界 |
| [neuron_runner.hpp](../../../src/neuron/neuron_runner/runner.hpp) | runner 配置模型与公开函数 |
| [neuron_runner.cpp](../../../src/neuron/neuron_runner/runner.cpp) | CLI 解析、protocol 配置、执行和输出 |
