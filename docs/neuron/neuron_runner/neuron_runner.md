...
对应 [neuron_runner.cpp](../../../src/neuron/neuron_runner/runner.cpp) 和 [neuron_runner.hpp](../../../src/neuron/neuron_runner/runner.hpp)。
...
当前测试目录已移除；验证以构建 `neuron_runner` 并运行实际单细胞命令为主。
